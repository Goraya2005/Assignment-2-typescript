...
var temp_Fahrenheit = 106;
var temp_Celsius = (temp_Fahrenheit - 32) * 5 / 9; // Celsius = (Fahrenheit - 32) * 5 / 9
console.log(temp_Celsius);
var temp_Celsius2 = 42;
var temp_Fahrenheit2 = (temp_Celsius2 * 9 / 5) + 32; // Fahrenheit = (Celsius × 9/5) + 32
console.log(temp_Fahrenheit2);
//  - Write a program that calculates the percentage.
var studentName = "Naeem Goraya";
var studentMarks = 1098;
var totalMarks = 1100;
var studentMarksPecentage = (studentMarks / totalMarks) * 100;
...
var divideNumber = 6777655786;
var divide3 = divideNumber % 3;
var divide5 = divideNumber % 5;
if (divide3 == 0) {
...
var dayNumber = 4; // Change this to a number between 1 and 7 for different results
if (dayNumber == 1) {
...
var unitConsumed = 776;
var unitValue = 37;
var consumedValue = unitConsumed * unitValue;
if (unitConsumed < 101) {
    var tax1 = consumedValue * 0 / 100;
    ...
    var tax1 = consumedValue * 10 / 100;
    console.log(`The bill amount is Pak Rs. ${consumedValue + tax1}, where it includes the tax amount SPak Rs. ${tax1}`);
}
else if (unitConsumed > 200 && unitConsumed < 301) {
    var tax1 = consumedValue * 15 / 100;
    console.log(`The bill amount is Pak Rs. ${consumedValue + tax1}, where it includes the tax amount SPak Rs. ${tax1}`);
}
else if (unitConsumed > 300 && unitConsumed < 401) {
    var tax1 = consumedValue * 20 / 100;
    console.log(`The bill amount is Pak Rs. ${consumedValue + tax1}, where it includes the tax amount SPak Rs. ${tax1}`);
}
else if (unitConsumed > 400 && unitConsumed < 501) {
    var tax1 = consumedValue * 325 / 100;
    console.log(`The bill amount is Pak Rs. ${consumedValue + tax1}, where it includes the tax amount SPak Rs. ${tax1}`);
}
else {
    var tax1 = consumedValue * 30 / 100;
    console.log(`The bill amount is Pak Rs. ${consumedValue + tax1}, where it includes the tax amount SPak Rs. ${tax1}`);
}
